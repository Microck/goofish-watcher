...
If not already cloned, clone it to `/tmp/ai-goofish-monitor` as a reference. Do NOT copy files wholesale — read, understand, and adapt the code to fit goofish-watcher's architecture.
...
5. Fix any breakage
6. If all criteria are met, output the promise. Otherwise, continue.
